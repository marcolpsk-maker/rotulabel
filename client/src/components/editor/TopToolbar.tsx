    ...
    <>
      <div className="h-12 border-b border-neutral-800 bg-gradient-to-r from-neutral-950 via-neutral-900 to-neutral-950 flex items-center px-2 sm:px-3 gap-1 sm:gap-2 shrink-0 z-10 shadow-md text-neutral-200 overflow-x-auto">
        ...
        >
          ...
          <span className="hidden lg:inline">Tabela ANVISA</span>
        </button>
        ...
        <div className="relative">
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 rounded text-xs font-medium text-white bg-gradient-to-r from-violet-600 to-fuchsia-600 hover:from-violet-500 hover:to-fuchsia-500 shadow-lg shadow-violet-900/40 transition-all"
          >
            <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
          ...
          {showExportMenu && (
            <div className="absolute right-0 top-full mt-1 bg-neutral-900 border border-neutral-700 rounded-lg shadow-xl z-50 min-w-40 py-1">
              <button
        ...
        <Link href="/projects" className="no-underline">
          <button className="flex items-center gap-1.5 px-2.5 py-1.5 rounded text-xs font-medium text-neutral-400 hover:bg-neutral-800 transition-colors">
            ...
            <span className="hidden xl:inline">Meus projetos</span>
          </button>
        </Link>
      </div>
